-- ============================================================
-- B1G HRIS — Migration: Admin File Leave On Behalf
-- Allows admins/super_admins to file leave for any employee,
-- bypassing VL 7-day notice and SL 2-hour rules, while still
-- enforcing balances and auto-approving with all side effects.
-- ============================================================
...
BEGIN
  ...
  -- Insert as pending, then reuse approve_leave_request to apply balances + attendance
