...
const PRESET_BUTTONS: Array<[Exclude<DatePreset, 'custom' | 'all'>, string]> = [
...
export function DateRangeFilterPopover({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      ...
      <PopoverContent className={className ?? 'w-[360px] max-w-[calc(100vw-2rem)] p-0'} align={align}>
